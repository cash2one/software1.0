...
urlpatterns = [
    ...
    url(r'^projectevent/(?P<pk>[1-9]\d*)/$', views.projectevent, name='projectevent'),
    ...
    url(r'^recommendproject/(?P<page>\d+)/$', views.recommendproject, name='recommendproject'),
    url(r'^waitforfinance/(?P<page>\d+)/$', views.waitforfinance, name='waitforfinance'),
