...
urlpatterns = [
    ...
    url(r'^defaultclassify/$', views.defaultclassify, name='defaultclassify'),
    ...
    url(r'^generalinformation/((?P<pk>[1-9]\d*)/)?$', views.generalinformation, name='generalinformation'),
    ...
    url(r'^knowledge/(?P<page>\d+)/$', views.knowledge, name='knowledge'),
    ...
    url(r'^hassysteminform/$', views.hassysteminform, name='hassysteminform'),
    ...
    url(r'^hasnewtopic/$', views.hasnewtopic, name='hasnewtopic'),
    ...
    url(r'^feelingbackground/$', views.feelingbackground, name='feelingbackground'),
]
