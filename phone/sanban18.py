...
def push():
    from phone.models import News
    from phone.utils import JiGuang
    from jinzht import settings
    ...
    JiGuang(news.title, extras).single('050eb8bcd2f')
    JiGuang(news.title, extras).single('050dee23230')
    JiGuang(news.title, extras).single('040013e6333')
